              ...
              <div className="space-y-6">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2 border border-slate-200 rounded-lg text-slate-900 focus:border-purple-500 focus:outline-none"
                  />
                </div>
                ...
                <div className="pt-4">
                  <button
                    onClick={handleSave}
                    className="flex items-center gap-2 px-6 py-2 bg-gradient-to-r from-purple-600 to-pink-500 text-white rounded-lg font-semibold hover:shadow-lg transition"
                  >
                    <Save size={18} />
                    Save Changes
                  </button>
                    ...
                    >
                      ...
                      <ChevronRight
                        className={`mt-2 transition ${
                          career === option ? 'text-purple-600' : 'text-slate-400'
                        }`}
                        size={18}
                      />
                    </button>
