          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {careerPaths.map((path) => (
              <button
                ...
                className={`text-left p-6 rounded-xl border-2 transition transform hover:scale-105 ${
              ...
              >
                ...
                <div className="mb-4">
                  <p className="text-xs text-slate-500 mb-2 font-semibold">Duration</p>
                  <p className="text-sm text-slate-700">{path.duration}</p>
                </div>
                <div>
                  <p className="text-xs text-slate-500 mb-2 font-semibold">Key Skills</p>
