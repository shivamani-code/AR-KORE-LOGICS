...
export function DashboardSidebar({ isOpen = true, onToggle = () => {} }) {
  ...
  const menuItems: MenuItem[] = [
    ...
    { icon: Sparkles, label: 'AIDex Studio', href: 'https://aidex-mauve.vercel.app/', external: true },
    { icon: Terminal, label: 'Promptly Studio', href: 'https://promptly-nine-sigma.vercel.app/', external: true },
