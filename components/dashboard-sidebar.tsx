...
export function DashboardSidebar({ isOpen = true, onToggle = () => {} }) {
  ...
  const menuItems: MenuItem[] = [
    ...
    { icon: Bot, label: 'AI Mentor Studio', href: 'https://ai-mentor-studio-by-arkore-logics.netlify.app/', external: true },
    { icon: Sparkles, label: 'AIDex Studio', href: 'https://aidex-ai-skills.netlify.app/', external: true },
    { icon: Terminal, label: 'Promptly Studio', href: 'https://promptlywebapp.netlify.app/', external: true },
    { icon: Wrench, label: 'Toolz Studio', href: 'https://toolz-studio.netlify.app/', external: true },
