...
const dashboardFeatures: Feature[] = [
  ...
  },
  {
    ...
    href: 'https://ai-mentor-studio-by-arkore-logics.netlify.app/',
    external: true,
    accent: 'purple',
  },
  {
  ...
  },
  {
    ...
    href: 'https://aidex-ai-skills.netlify.app/',
    external: true,
    accent: 'purple',
  },
  {
    id: 'promptly',
    icon: Terminal,
    title: 'Promptly Studio',
    badge: '220k+ AI Prompts',
    category: 'ai',
    description: 'Find reusable AI prompts across 22 domains, AI prompt generator tools, and engineering templates.',
    details: ['220,000+ curated prompts', '22 domain categories', 'AI prompt generator'],
    href: 'https://promptlywebapp.netlify.app/',
    external: true,
    accent: 'purple',
  },
  {
