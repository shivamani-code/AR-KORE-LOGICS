    ...
    <nav className="fixed top-0 left-0 right-0 md:left-64 h-16 bg-white border-b border-slate-200 flex items-center justify-between px-4 sm:px-6 z-40 shadow-sm">
      <div className="flex-1 max-w-xs sm:max-w-md">
        <div className="relative">
          ...
          <input
            type="text"
            placeholder="Search..."
            className="w-full pl-10 pr-4 py-2 bg-slate-50 border border-slate-200 rounded-lg text-sm sm:text-base text-slate-900 placeholder-slate-400 focus:border-purple-500 focus:outline-none transition"
      ...
      <div className="flex items-center gap-3 sm:gap-6 ml-3 sm:ml-6">
        ...
        <div className="flex items-center gap-2 sm:gap-3 pl-3 sm:pl-6 border-l border-slate-200">
          ...
          <button
            className="w-10 h-10 bg-gradient-to-br from-purple-600 to-pink-500 rounded-full flex items-center justify-center hover:shadow-lg hover:shadow-purple-300/50 transition flex-shrink-0"
